...
const Feature = () => {
  return (
    ...
    className='w-full bg-zinc-600'>
        ...
        <h1 className='text-[8vw] tracking-normal leading-none font-light font-founder'>Featured Projects</h1>
        </div>

        <div className="relative w-full h-screen flex items-center justify-between gap-5 px-16">
            <div className="cards-container relative z-[2] w-1/2 h-[80vh] bg-green-400 rounded-xl cursor-pointer">
