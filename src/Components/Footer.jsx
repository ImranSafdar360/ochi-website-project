...
const Footer = () => {
  return (
    <>
      <div data-scroll data-scroll-speed=".3" className="w-full h-[100vh] font-[a] px-16 pb-10 flex justify-between overflow-hidden text-black">
      <div className="w-1/2 h-full pt-20 flex flex-col justify-between font-founder">
        <div>
      ...
      <div className="w-1/2">
        <h1 className="uppercase text-[10.3vw] leading-none font-founder">Presentation</h1>

        <div className="main h-full w-full font-[ccc] flex justify-between">
          <div className="left h-full w-1/2">
            <div className="flex flex-col pt-6 font-neuemontreal">
          ...
          <div className="right w-1/2 h-full font-neuemontreal p-3">
