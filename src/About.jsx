...
const About = () => {
  return (
    <>
      ...
      <h2 className="py-8 px-16 text-[4vw] leading-none text-zinc-900 -tracking-[0.09vw] font-neuemontreal">
      ...
      <div className="border-t border-b border-zinc-600 px-16 text-zinc-900 pt-5 flex justify-between w-full">
        ...
        <div className="w-1/2 flex items-center justify-between pb-16">
          <div className="w-[70%] pe-[10vw] font-neuemontreal">
            <p >
              We create tailored presentations to help you persuade your
              colleagues, clients, or investors. Whether it's live or digital,
              delivered for one or a hundred people.
            </p>
            <p className="py-10 font-neuemontreal">
              We believe the mix of strategy and design (with a bit of coffee)
              is what makes your message clear, convincing, and captivating.
            </p>
          </div>
          <div className="flex flex-col w-[30%] font-neuemontreal">
            S:
            <a href="#">Instagram</a>
            <a href="#">Behance</a>
            <a href="#">Facebook</a>
      ...
      <div className="px-16 pt-5 pb-10 w-full flex justify-between">
        <div className="w-1/2 text-zinc-900">
          <h1 className="text-[3.8vw] text-zinc-800 leading-none font-founder">Our approach:</h1>
